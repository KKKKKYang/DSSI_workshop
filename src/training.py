...
features = ['yearly_income','is_female','months_residence','dual_income',
            'have_minors']
numeric_features = ['yearly_income','months_residence']
categorical_features = ['is_female','dual_income','have_minors']
